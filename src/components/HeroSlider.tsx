    ...
    return (
        <div className="relative w-full bg-background mt-0">
            ...
            <div className="hero min-h-screen flex items-center relative overflow-hidden">
                ...
                <div
                    className="absolute inset-y-0 left-0 w-[50%] md:w-[60%] z-0 pointer-events-none"
                    style={{
                ...
                <div className="hero-container z-10 w-full pl-0 flex items-center h-full">
                    <div className="relative p-10 md:p-14 max-w-[900px]">

                        {/* Text Content */}
                        <div className="relative z-10 space-y-4 text-left">
                            <h1
                                className="font-bold tracking-tight leading-[1.1] text-white whitespace-nowrap"
                                style={{
                ...
                >
                    ...
                    <div className="flex w-full whitespace-nowrap">
                        {[0, 1].map((i) => (
                            ...
                            >
                                <span className="flex items-center gap-4 text-white text-[20px] font-normal uppercase tracking-wide" style={{ fontFamily: 'Matter, sans-serif' }}>Book your consultation @ Rs. 499 <span className="line-through opacity-70">Rs. 699</span></span>
                                <span className="flex items-center gap-4 text-white text-[20px] font-normal uppercase tracking-wide italic font-semibold" style={{ fontFamily: 'Matter, sans-serif' }}>Slots are limited</span>
                                <span className="flex items-center gap-4 text-white text-[20px] font-normal uppercase tracking-wide font-bold" style={{ fontFamily: 'Matter, sans-serif' }}>Reserve yours now !!</span>
